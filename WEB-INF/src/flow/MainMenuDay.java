 ...
 */
public class MainMenuDay extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("故障报修", "3", true, "exact", "ToRenGong", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("投诉建议", "7", true, "exact", "ToRenGong", grammarInfo, true);
		list.add(choice);
