 ...
 */
public class TScust extends com.avaya.sce.runtime.BasicServlet {
	private static final Logger logs = Logger.getLogger(TScust.class);
	//{{START:CLASS:FIELDS
	//}}END:CLASS:FIELDS
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		logs.debug("托收查询开始......."+"客户号："+custField.getStringValue()+".....月份："+monthField.getStringValue());
		
		try {
			List  list  =	AppUtil.getTSQF(custField.getStringValue(),monthField.getStringValue());
			/*if(vo!=null){
