 ...
 * Last generated by Orchestration Designer at: 2016年8月30日 上午07时32分20秒
 */
public class TransferToCell extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("AVAYA_SIPHEADER.session.connection.protocol.sip.referto.header[0]", "P-Intrinsics=");
		list.add(property);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Disconnect");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add("TransferAgent_008");

		// create the transfer item
		transfer = new com.avaya.sce.runtime.Transfer("TransferToCell", "6001", com.avaya.sce.runtime.Transfer.CONSTANT, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "", com.avaya.sce.runtime.Transfer.CONSTANT, false, false);
		return transfer;
	}
	/**
