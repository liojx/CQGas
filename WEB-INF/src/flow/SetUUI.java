...
public class SetUUI extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		String dOn = mySession.getVariable("dayOrNight").getSimpleVariable().getStringValue();
		...
		IVariableField mainMenuField = null;
		if("d".equals(dOn)){
			mainMenuField = mySession.getVariableField(IProjectVariables.MAIN_MENU_DAY, IProjectVariables.MAIN_MENU_DAY_FIELD_UTTERANCE);
		}else{
			mainMenuField = mySession.getVariableField(IProjectVariables.MAIN_MENU_NIGHT, IProjectVariables.MAIN_MENU_DAY_FIELD_UTTERANCE);
		}
