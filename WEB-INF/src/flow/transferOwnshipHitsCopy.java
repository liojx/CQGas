 ...
 */
public class transferOwnshipHitsCopy extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: (timestamp generation disabled)
	 */
	public transferOwnshipHitsCopy() {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("transferOwnshipHints", "English"));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ReplayNoticeCopy");
		return submit;
	}
	/**
