 ...
 */
public class GetCustType extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		try {
			CustomerVO  vo  =	AppUtil.getCustomerVO(yqzh_field.getStringValue());
			if(vo!=null){
				custtypeField.setValue(vo.getYqdz_kh_lx());
				kh_field.setValue(vo.getYqdz_kh_id());
			}
		} catch(EmptyResultDataAccessException e){
			 int res =	AppUtil.checkTuoshou(yqzh_field.getStringValue());
			  if(res > 0){
				  custtypeField.setValue("3");
			  }
		}
		catch (Exception e) {
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("checkCust", 0, true, "Default");
		list.add(aGoto);
