 ...
 * Last generated by Orchestration Designer at: 2016年8月30日 下午08时25分29秒
 */
public class Welcome_1 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Welcome_010", "Chinese"));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Important_Report");
		return submit;
	}
	/**
