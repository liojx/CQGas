 ...
 */
public class BizMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("申请须知", "2", true, "exact", "applyGasHints", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("过户须知", "3", true, "exact", "transferOwnshipHits", grammarInfo, true);
		list.add(choice);
