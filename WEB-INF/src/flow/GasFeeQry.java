 ...
 * Last generated by Orchestration Designer at: 2016年8月29日 下午08时26分36秒
 */
public class GasFeeQry extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("InputCustNum_002", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("CollectCustNum", "1.0", "Chinese"));


		// build events for the field: "GasFeeQry"
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ThreeCts", 0, true, ""));
		events.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ThreeCts", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("GasFeeQry", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("GetCustType");
		return submit;
	}
	/**
