 ...
 * Last generated by Orchestration Designer at: 2016年9月7日 下午08时47分38秒
 */
public class ErrorMonth extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("ErrorMonth_023", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CollectMonth");
		return submit;
	}
	/**
