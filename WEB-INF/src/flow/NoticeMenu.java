...
public class NoticeMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (String[])eventPromptNames.toArray(new String[0]), new com.avaya.sce.runtime.Goto("ThreeCtsCopy4", 0, true, ""));
		list.add(event);
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String[])eventPromptNames.toArray(new String[0]), new com.avaya.sce.runtime.Goto("ThreeCtsCopy4", 0, true, ""));
		list.add(event);
