 ...
 * Last generated by Orchestration Designer at: 2016年8月30日 下午08时57分23秒
 */
public class SafeKnowledge extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("SafeKnowledge_012", "Chinese"));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ReplaySafe");
		return submit;
	}
	/**
