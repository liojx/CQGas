 ...
 * Last generated by Orchestration Designer at: 2016年8月30日 下午09时18分21秒
 */
public class BusiMenu6 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("BusiMenu_018", "Chinese"));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("BusiConsMenu");
		return submit;
	}
	/**
