 ...
 */
public class BizMenuCopy extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("气价查询", "1", true, "exact", "gasPriceCopy", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("申请须知", "2", true, "exact", "applyGasHintsCopy", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("过户须知", "3", true, "exact", "transferOwnshipHitsCopy", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("返回上级菜单", "*", true, "exact", "judgeDayOrNightData", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Biz4nightMenu", "English"));
