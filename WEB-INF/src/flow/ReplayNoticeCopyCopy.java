 ...
 */
public class ReplayNoticeCopyCopy extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("重听", "1", true, "exact", "commenSense_1", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("返回上一级", "*", true, "exact", "JudgeDayOrNight", grammarInfo, true);
		list.add(choice);
