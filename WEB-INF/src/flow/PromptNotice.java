 ...
 * Last generated by Orchestration Designer at: 2016年8月30日 上午08时22分27秒
 */
public class PromptNotice extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("NoticeMsg_000", "Chinese"));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ReplayNotice");
		return submit;
	}
	/**
