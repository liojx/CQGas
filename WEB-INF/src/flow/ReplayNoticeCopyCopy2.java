 ...
 */
public class ReplayNoticeCopyCopy2 extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("重听", "9", true, "exact", "judgeBtnCopy", grammarInfo, true);
		list.add(choice);
