 ...
 * Last generated by Orchestration Designer at: 2016年9月9日 下午08时40分57秒
 */
public class businessQry extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		eventPromptNames.add(new com.avaya.sce.runtime.PromptRefInfo("ErrorCtsLimit_005", ""));

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("ErrorOpt1", 3, true, ""));
		list.add(event);
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("气价查询", "1", true, "exact", "gasPrice", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("居民通气申请须知", "2", true, "exact", "applyGasHints", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("居民及工商户过户须知", "3", true, "exact", "transferOwnshipHits", grammarInfo, true);
		list.add(choice);
