 ...
 * Last generated by Orchestration Designer at: 2016年9月7日 下午07时37分05秒
 */
public class ErrorCustNo extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("ErrorCustNo_022", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("GasFeeQry");
		return submit;
	}
	/**
