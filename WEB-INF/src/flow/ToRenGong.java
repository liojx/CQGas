 ...
 * Last generated by Orchestration Designer at: 2016年9月14日 下午03时47分42秒
 */
public class ToRenGong extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("TransferAgent_008", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SetUUI");
		return submit;
	}
	/**
