 ...
 */
public class judgeDayOrNightDataCopy extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: (timestamp generation disabled)
	 */
	public judgeDayOrNightDataCopy() {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "dayOrNight", com.avaya.sce.runtime.Expression.STRING_EQUAL, "d", false).setDebugId(1253)).evaluate(mySession)) {
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("NightAnnon", "夜间").setDebugId(1256));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
