 ...
 * Last generated by Orchestration Designer at: 2016年8月30日 下午09时40分05秒
 */
public class PromptRes extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("GasFeeRes_020", "Chinese"));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ReplayFeeInfo");
		return submit;
	}
	/**
